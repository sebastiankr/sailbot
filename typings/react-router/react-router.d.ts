...
declare module ReactRouter {
    ...
    // Top-Level
    // ----------------------------------------------------------------------
    interface IRouter extends React.ReactElement<any> {
    ...
    function create(options: RouterCreateOption): IRouter;
    function run(routes: Route, callback: RouterRunCallback): IRouter;
    function run(routes: Route, location: LocationBase | string, callback: RouterRunCallback): IRouter;
